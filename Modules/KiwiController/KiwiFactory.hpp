...
namespace kiwi
{
    ...
    private:
        ...
        public:
            ...
            virtual inline Object* create(Infos const& infos) = 0;

            //virtual inline sObject create(Infos const& infos) = 0;
        };
        ...
        {
        public:
            inline Object* create(Infos const& init) override {return new T(init);}
            //inline sObject create(Infos const& init) override {return std::make_shared<T>(init);}
        };
    ...
    public:
        ...
        template <class T> static void add(sTag name = Tags::_empty)
        {
            ...
            sObject object = std::make_shared<T>(Infos());
            if(object)
            {
        ...
        /** This function creates an object.
         ...
         @return An object.
         */
        static Object* create(const sTag name, Infos const& infos);
