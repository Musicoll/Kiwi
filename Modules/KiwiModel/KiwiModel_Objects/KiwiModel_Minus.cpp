...
namespace kiwi { namespace model {
    ...
    void Minus::declare()
    {
        ...
        Factory::add<Minus>(std::move(minus_class), minus_model);
    }
    
    std::unique_ptr<Object> Minus::create(std::vector<tool::Atom> const& args)
    {
        return std::make_unique<Minus>(args);
    }
    
    Minus::Minus(std::vector<tool::Atom> const& args):
    Operator(args)
    {
    }
