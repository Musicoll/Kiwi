...
namespace dsp
{
    ...
    {
        static_assert(std::is_floating_point< Type >::value, "The type of sample must be floating point.");
        static_assert(!std::is_const< Type >::value, "The type of sample can't be constant.");
    public:
